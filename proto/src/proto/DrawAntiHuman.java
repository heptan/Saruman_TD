...
/**
 * Az AntiHuman rajzolo objektuma, kirajzolja a k�veket. Az emberek elleni
...
public class DrawAntiHuman {
	...
	/**
	 * a parameterkent kapott g objektummal kirajzoltat egy piros sz�nu rombuszt
	 * a megkapott o objektum poziciojanak megfelelo negyzetracs jobb kozepso
	 * hatodaba.
	 * 
	 * @param o
	 *            A kirajzolando Human elleni varazsko
	 * @param g
	...
	public void draw(AntiHuman o, Graphics g) {
		...
		g.fillPolygon(new int[] { x * tilesize + tilesize / 2,
				...
				y * tilesize + tilesize / 2, y * tilesize + tilesize / 3,
				y * tilesize + tilesize / 2, y * tilesize + tilesize * 2 / 3 },
				4);
	}
}
