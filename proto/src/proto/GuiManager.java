...
public class GuiManager {
	...
	public void itsOver() {
		if (gamecontroller.getWin()) {
			JOptionPane.showMessageDialog(frame, "On nyert!", "Nyert!", JOptionPane.INFORMATION_MESSAGE);
			return;
		}
		if (gamecontroller.getGameOver()) {
			JOptionPane.showMessageDialog(frame, "On vesztett!", "Vesztett!", JOptionPane.INFORMATION_MESSAGE);
			return;
		}
	}
