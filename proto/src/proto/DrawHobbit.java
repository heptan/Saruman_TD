...
//				tilesize / 2 - 4, tilesize / 2 - 4);
		...
		Image im = new ImageIcon("textures/hobbit.png").getImage();
		g.drawImage(im, x * tilesize, y * tilesize + tilesize / 2, x * tilesize
				+ tilesize / 2, y * tilesize + tilesize, 0, 0, im.getWidth(null),
