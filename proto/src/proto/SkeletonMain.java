...
/*
 * A szkeleton keret�t ad� oszt�ly, � felel�s a megfelel� teszteset 
 * megh�v�s��rt a felhaszn�l� inputja alapj�n.
 */
public class SkeletonMain {
	...
	static public void main(String[] args) {
		int select = 0;
		do {
			// V�laszlehet�s�gek felsorol�sa, majd a v�lasz bek�r�se
	...
	/*
	 * Ellens�g �ltal�nos p�lyaelemre l�p.
	 */
